...
env = gym.make("CartPole-v0")  #gym.make('LobotArmMoveSimple-v1')
env = env.unwrapped
env.seed(1)
...
def dense_model():
    ...
    #dense_layer1 = Dense(24, activation='relu', kernel_initializer='glorot_uniform', name='dense1')
    dense_layer1 = Dense(24, activation='relu', name='dense1')
    dense_output1 = dense_layer1(state_input)
    #dense_layer2 = Dense(24, activation='relu', kernel_initializer='glorot_uniform', name='dense2')
    dense_layer2 = Dense(24, activation='relu', name='dense2')
