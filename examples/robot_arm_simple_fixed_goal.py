...
import numpy
import openai_ros2
from openai_ros2.envs import LobotArmMoveSimpleEnv #LobotArmMoveRandomConActEnv   #LobotArmMoveSimpleEnv
...
env: LobotArmMoveSimpleEnv= gym.make('LobotArmMoveSimple-v0')   #'LobotArmMoveSimple-v0' LobotArmMoveSimpleEnv
...
while True:
    ...
    for x in range(500):
        ...
        # Type hints
        observation: LobotArmMoveSimpleEnv.ObservationData  #LobotArmMoveSimpleEnv
        reward: float
        done: bool
        info: str
        if done:
