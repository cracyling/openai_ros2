...
class LobotArmContinuousEnv(gym.Env):
    ...
    def __init__(self):
        ...
        self.action_space = Box(numpy.array([-2.356,-1.57079632679,-1.57079632679]), numpy.array([2.356,1.57079632679,1.57079632679]))    #TODO more dimension limit, i.e. -2 to 2 for joint1, -1 to 1 for joint2
